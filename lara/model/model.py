...
#        print( test_G_user[:10])
        ...
        print('EPOCH: ', it, ' mean average precision: ',M_at_20, ' ndcg: ',G_at_20)
        # print('MAX: ', ' mean average precision: ',max_M_at_20,' ndcg: ',max_G_at_20)
    if it % 100 == 0:
        pd.DataFrame(M_20_to_save).to_csv('MAP.csv')
        pd.DataFrame(G_20_to_save).to_csv('ndcg.csv')
